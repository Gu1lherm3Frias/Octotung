...
s                <h2><fmt:message key="login.title"/></h2>
                ...
                <form class="login-form" action="login" method="POST">
                    ...
                    <p><fmt:message key="login.forgot-password.p"/><a class="alt-links" href="password-recovery.jsp"><fmt:message key="login.forgot-password.a"/></a></p>
                    <button type="submit"><fmt:message key="login.submit.button"/></button>
                </form>
                <p><fmt:message key="login.new-account.p"/><a class="alt-links" href="register.jsp"><fmt:message key="login.new-account.a"/></a></p>
            </div>
